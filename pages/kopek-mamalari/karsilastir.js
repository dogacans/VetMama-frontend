...
export default function DogFeed({contents}) {
...
export async function getServerSideProps(context) {
  // Call an external API endpoint to get posts
    // let queryString = context.resolvedUrl.replace("/kopek-mamalari/karsilastir?", "")
    // console.log('context.query: ', context.query);
    // console.log('Object.keys(context.query): ', Object.keys(context.query));
