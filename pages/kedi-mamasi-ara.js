...
export default function SearchDogFeed({parameters}) {
  ...
  useEffect(() => {
    ...
    setSearchLink(`/kedi-mamalari?${params.join("&")}`)
  }, [age,
    specs,
    feedType,
    flavor,
...
export async function getStaticProps() {
  ...
  const res = await fetch('http://localhost:3001/searchParameters/cat')
