...
export default function CatFeed({feeds}) {
...
export async function getServerSideProps(context) {
  // Call an external API endpoint to get posts
    let queryString = context.resolvedUrl.replace("/kedi-mamalari", "")
    const res = await fetch(`http://localhost:3001/searchFeed/cat/${queryString}`)
